  ...
  return (
    <>
      ...
      <div>
        ...
        <p><strong>Flag:</strong> <img src={selectedCountry.flags.png} alt={`Flag of ${selectedCountry.name.common}`} width="100" /></p>
        <p><strong>Coat of Arms:</strong> <img src={selectedCountry.coatOfArms.png} alt={`Coat of Arms of ${selectedCountry.name.common}`} width="100" /></p>
